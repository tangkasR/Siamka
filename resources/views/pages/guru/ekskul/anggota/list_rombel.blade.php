...
@section('back')
    <div class="font-medium  border border-slate-500 bg-slate-500 text-white rounded-full  me-3">
        <a href="{{ route('guru.ekskul.daftar_anggota', ['tahun' => $tahun, 'semester' => $semester, 'id' => Crypt::encrypt($ekskul->id)]) }}"
                                        ...
                                        <div class="swiper-slide">
                                            <div
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="">
                                                        <a href="{{ route('guru.ekskul.show-siswa', ['tahun' => $tahun, 'semester' => $semester, 'ekskul' => $ekskul, 'rombel' => $data]) }}"
