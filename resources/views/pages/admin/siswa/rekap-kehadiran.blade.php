...
@section('table-name', 'Rekap Kehadiran Siswa')
@section('table-role', 'Admin')
@section('back')
    <div class="font-medium  border border-slate-500 bg-slate-500 text-white rounded-full  me-3">
        <a href="{{ route('admin.siswa.detail_siswa', ['tahun' => $tahun, 'semester' => $semester, 'rombel' => $rombel, 'id' => Crypt::encrypt($siswa->id)]) }}"
                    ...
                    <div class="md:col-span-3">
                        <div class="">
                            ...
                            <input
                                ...
                                type="month" id="month" value="{{ $month_val }}">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                type: "GET",
                url: '{{ route('admin.siswa.get_rekap_kehadiran') }}',
                data: {
                    'nis': nis,
                    'tahun': tahun_rekap
                },
