...
@section('back')
    <div class="font-medium  border border-slate-500 bg-slate-500 text-white rounded-full  me-3">
        <a href="{{ route('tahun_ajaran.index', 'admin_nilai') }}" class="flex justify-center items-center"><i
                                        ...
                                        <div class="swiper-slide">
                                            <div
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="">
                                                        <a href="{{ route('admin.kehadiran.detail_kehadiran', ['tahun' => $tahun, 'semester' => $semester, 'rombel' => $data]) }}"
