...
@section('table-name', 'Data Ekstrakurikuler')
                                ...
                                @foreach ($rombels as $data)
                                    @if (explode(' ', $data->nama_rombel)[0] == 'X')
                                        <div class="swiper-slide">
                                            <div
                                                class="card dark:bg-zinc-800 dark:border-zinc-600 bg-blue-50 border-blue-50 border-2 hover:border-violet-300  hover:border-2 hover:bg-blue-200 ">
                                                <div class="card-body  ">
                                                    ...
                                                    <div class="">
                                                        <a href="{{ route('guru.ekskul.show-siswa', ['id' => $id, 'rombel_id' => $data->id]) }}"
