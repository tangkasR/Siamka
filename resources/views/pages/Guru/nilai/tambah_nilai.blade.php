                        ...
                        <div class="px-[10px] pb-[20px] w-full ">
                            ...
                            <div class="grid md:grid-cols-3 md:gap-4 gap-3">
                                @foreach ($siswas as $data)
                                    ...
                                    <div class="card dark:bg-zinc-800 dark:border-zinc-600 ">
                                        <div class="card-body grid md:grid-cols-12 md:gap-3">
                            ...
                            <div class="flex gap-3">
                                <button type="submit"
                                    class="px-10 py-2 rounded-md mt-5 hover:bg-violet-600 bg-violet-400 text-[16px] font-medium text-white "
                                    {{ count($rombel->siswas) == 0 ? 'hidden' : '' }}>Simpan</button>
                                <a href="{{ route('guru.nilai.show_siswa', ['id' => $rombel->id]) }}"
                                    class="px-10 py-2 rounded-md mt-5 hover:bg-gray-600 bg-gray-400 text-[16px] font-medium text-white "
                                    {{ count($rombel->siswas) == 0 ? 'hidden' : '' }}>Batal</a>
                            </div>
